...
# opencores_i2c sources root 
opencores_i2c_SRCS_ROOT := drivers

# opencores_i2c sources 
opencores_i2c_C_LIB_SRCS := \
	$(opencores_i2c_SRCS_ROOT)/src/opencores_i2c.c
